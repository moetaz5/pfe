...
const API_URL = "http://51.178.39.67.nip.io"; // ⬅️ change si ton backend est sur un autre port
      ...
      <form className="form-card" onSubmit={onSubmit}>
        ...
        <div className="form-actions">
          ...
          <button 
            ...
            type="button" 
            onClick={() => navigate("/dashboard/profil/ChangePassword")}
            style={{ marginLeft: 'auto', border: '1px solid #0247AA', color: '#0247AA' }}
          >
