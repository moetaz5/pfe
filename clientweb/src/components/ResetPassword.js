...
const ResetPassword = () => {
  ...
  const handleReset = async (e) => {
    ...
    try {
      const res = await axios.post("http://51.178.39.67.nip.io/api/auth/reset-password", {
        email,
        code,
        newPassword,
      });
  ...
  const handleResend = async () => {
    ...
    try {
      const res = await axios.post("http://51.178.39.67.nip.io/api/auth/resend-reset-code", {
        email,
      });
